...
di casa e una squadra ospite, punti fatti dalla squadra di casa e 
...
<body>
    <?php for($i = 0; $i < count($matches); $i++){
        ...
        ?>
        <p>
            <?php echo $matches[$i]["team1"]?> - <?php echo $matches[$i]["team2"]?> | <?php echo $matches[$i]["point_team_1"]?>-<?php echo $matches[$i]["point_team_2"]?> -->
        </p>
  <?php  }?>
</body>
</html>